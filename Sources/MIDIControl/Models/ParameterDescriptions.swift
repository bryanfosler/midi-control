...
enum ParameterDescriptions {
    ...
    private static let lookup: [String: String] = [
        ...
        "ramping_waveform": "Selects the shape of automated parameter ramping movement:\n\n• Sine (0–14): Smooth, natural wave oscillation.\n• Triangle (15–54): Linear back-and-forth sweep.\n• Ramp (55–80): Sawtooth — ramps up then snaps back to start.\n• Square (81–126): Instant jumps between two extreme positions — precise two-point movement.\n• Random (127): Unpredictable, random steps.\n\nShapes smoothly warp into one another between range boundaries.",
